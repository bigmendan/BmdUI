package com.bmd.bmd_ui.view.popup;
 ...
 */
public class HiPopupWindow extends PopupWindow {
    ...
    public HiPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static class Builder {
        private HiPopupWindow mWindow;

        private Builder(Activity activity, View view) {
            mWindow = new HiPopupWindow(activity);
         ...
         * @return
         */
        public HiPopupWindow createPopupWindow() {
            mWindow.init();
            return mWindow;
        }
    }
